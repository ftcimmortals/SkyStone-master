 ...
 */
@Autonomous(name = "R-F-Far", group = "Skystone")
//@Disabled                            // Comment this out to add to the opmode list

public class AutoRedFoundationParkFar extends LinearOpMode {
    ...
    public void runOpMode (){
        ...
        moveForwardTime(0.5, true, 0.7*timeMultiple);
        ...
        sleep(500);
        foundationGrabberServo.setPosition(FOUNDATION_GRABBER_UP);
        moveForwardTime(0.5, false, 2*timeMultiple);
        moveSideTime(0.5, false, 0.5*timeMultiple);
        moveForwardTime(0.5, true, 0.50*timeMultiple);
        moveStop();
